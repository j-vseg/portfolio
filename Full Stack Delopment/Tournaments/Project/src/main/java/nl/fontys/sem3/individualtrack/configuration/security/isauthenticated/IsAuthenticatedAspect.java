package nl.fontys.sem3.individualtrack.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(nl.fontys.sem3.individualtrack.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(nl.fontys.sem3.individualtrack.configuration.security.isauthenticated.IsAuthenticated)")
